      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          <View style={styles.logoSection}>
            {event.logo && (
              <Image source={{ uri: event.logo }} style={[styles.logo, { borderColor: getThemeColor() }]} />
            )}
          ...
          <View style={styles.actionsRow}>
            ...
            {event.promoterName && (
              <TouchableOpacity
                style={[styles.venueButton, styles.roundedFull, { borderColor: getThemeColor() }]}
                onPress={() =>
                  event.promoterId &&
          ...
          <View style={[styles.quickLinksSection, { borderColor: getThemeColor() + '30' }]}>
            ...
            <View style={[styles.quickLinksDivider, { backgroundColor: getThemeColor() + '20' }]} />
            <View style={styles.quickLinksButtons}>
              {quickLinks.length > 0 ? (
                quickLinks.map((quickLink, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <View style={[styles.quickLinkIconContainer, { backgroundColor: getThemeColor() }]}>
                          <QuickLinkIcon size={24} color="#fff" />
                        </View>
                        <Text style={styles.quickLinkText} numberOfLines={2}>{quickLink.type}</Text>
                        <ExternalLink size={14} color="rgba(255,255,255,0.5)" style={styles.quickLinkArrow} />
                      </TouchableOpacity>
                      {isAdmin && (
                        <TouchableOpacity
                          onPress={() => {
                          ...
                          style={[
                            ...
                            (!quickLink.id ||
                              quickLink.id === "0" ||
                              String(quickLink.deleteable) !== "1") &&
                              styles.deleteLinkButtonDisabled,
                          ]}
                          disabled={
                            !quickLink.id ||
                            quickLink.id === "0" ||
                ...
                <View style={styles.quickLinksEmpty}>
                  ...
                  <Text style={styles.quickLinksEmptyText}>No quick links available</Text>
                </View>
              )}
            </View>
          </View>
                ...
                <View style={styles.modalBody}>
                  ...
                  {newLinkLabel.trim() && (
                    <View style={styles.iconPreviewContainer}>
                      <View style={[styles.iconPreviewCircle, { backgroundColor: getThemeColor() }]}>
                        {(() => {
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    />
                    <Text style={styles.inputHint}>Icon is auto-selected based on label</Text>
                  </View>
              ...
              {eventAlerts.length > 5 && (
                ...
                >
                  <Text style={[styles.seeMoreText, { color: getThemeColor() }]}>
                    {showAllAlerts ? 'Show Less' : `See More (${eventAlerts.length - 5} more)`}
                  </Text>
                </TouchableOpacity>
              )}
            </View>
          ...
          >
            ...
            >
              <View style={[styles.actionMenuContent, { borderColor: getThemeColor() + '30' }]}>
                ...
                >
                  <View style={[styles.actionMenuIcon, { backgroundColor: getThemeColor() }]}>
                    <Link2 size={20} color="#fff" />
                  </View>
                  <View style={styles.actionMenuTextContainer}>
                    <Text style={styles.actionMenuItemTitle}>Add Quick Link</Text>
                    <Text style={styles.actionMenuItemSubtitle}>Add a new link to quick access</Text>
                  </View>
                ...
                >
                  ...
                  <View style={styles.actionMenuTextContainer}>
                    ...
                    <Text style={styles.actionMenuItemSubtitle}>Notify subscribers about updates</Text>
                  </View>
                  <ChevronRight size={20} color="#737373" />
                </TouchableOpacity>
                <TouchableOpacity
          ...
          <View style={[styles.sectionCard, { borderColor: getThemeColor() + '30' }]}>
            ...
            <View style={[styles.sectionCardDivider, { backgroundColor: getThemeColor() + '20' }]} />
            <View style={styles.sectionCardContent}>
              {(event.address || (event.latitude && event.longitude) || event.phone || event.email) ? (
                <>
                  {event.address && (
                ...
                <View style={styles.sectionCardEmpty}>
                  ...
                  <Text style={styles.sectionCardEmptyText}>No event information available</Text>
                </View>
              )}
            </View>
          </View>
